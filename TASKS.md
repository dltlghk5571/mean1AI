...
## 마지막 수행 · G2.1 기초생활보장 안내의 기준 연도 대조
...
## 다음 한 가지 · G2.1 긴급복지 안내의 기준·요청 경로 검수

- 상위 목표: G2 성남 업무에 맞는 근거 → G0 위기 상황의 시민에게 현재 근거와 요청 경로 안내.
- 결과물: 기존 [공식 자료 작업표](docs/SEONGNAM_DATA_REVIEW.md)의 R03 중 긴급복지
  사업 24011 한 건의 성남시·국가 안내와 후보 질문을 대조한 기록.
- 완료 증거: 공개 자료의 실제 조회 시각, 기준 연도·소득/재산 기준과 지원액의 의미를 구분하고
  지원 요청·현장 확인·결정 절차의 역할을 확인. A·C의 적용 전 결정과 미확인 범위를 기록.
- 제외: 실제 위기 사례·개인 소득·재산 정보 수집, 수급 자격·지원액 계산, 위험 판단 규칙 변경,
  로그인·기관 문의·제출, 다른 복지사업 확대, 후보 JSON·자료 승인·모델·UI·새 플랫폼 구현.
- 의존성·종료: 공개 자료를 읽기 전용으로 대조하고 시행 기준·이용 범위 미확인은 필요한 추가
  근거와 담당을 남긴 뒤 한 사업에서 종료. 서버·실제 참여자와 독립적으로 수행 가능.

G2.1의 RD02·무단투기 D01~05·기초연금 P01~05·활동지원 AS01~05·기초생활보장 BL01~05는
추가 근거·A·C 검토 대기다. 문의는 발송하지 않는다.
...
| G2.1 대표 업무 자료 검수 | 한 번에 한 업무의 근거를 확인하고 12개 후보의 검수 상태를 누적 | 가로등·도로·RD02·무단투기·기초연금·활동지원·기초생활보장 공개 대조 완료. 이용 범위·신고서·관할·정책 시점·하단 역할 확정은 추가 근거와 A·C 검토 대기 | A·C |
