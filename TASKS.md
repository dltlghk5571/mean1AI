...
## 마지막 수행 · G2.1 긴급복지 안내의 기준·요청 경로 검수
...
## 다음 한 가지 · G2.1 공공 하수도·맨홀 역류의 담당·시설 경계 검수

- 상위 목표: G2 성남 업무에 맞는 근거 → G0 시민이 시설 이름·부서를 몰라도 배수 불편을 설명.
- 결과물: 기존 [공식 자료 작업표](docs/SEONGNAM_DATA_REVIEW.md)에 `pilot-service-sewer`
  한 업무의 세 구 담당 근거, R04 분당구 빗물받이와 하수도 경계, 후보 질문 네 개의 대조 기록.
- 완료 증거: 공식 업무표·신고 안내의 실제 조회 시각, 하수도·도로 배수구·실내 배관 구분의
  확인/미확인 범위와 A·C의 적용 전 결정 기록. 모호한 시설을 시민에게 확정하게 요구하지 않음.
- 제외: 현장 진단·좌표/시설 색인·소유권 추정, 사유지 배관·상수도 등 다른 업무 확대,
  후보 JSON·앱·자료 승인·위험 규칙 변경, 로그인·실제 신고·기관 연락·새 플랫폼.
- 의존성·종료: 공개 자료를 읽기 전용으로 대조. 전체 관할·시설 인수인계·신고 필수 항목을
  확인하지 못하면 추가 근거와 담당을 남기고 한 업무에서 종료. 로컬 서버는 시작하지 않음.

G2.1의 RD02·무단투기 D01~05·기초연금 P01~05·활동지원 AS01~05·기초생활보장 BL01~05·
긴급복지 EW01~05는 추가 근거·A·C 검토 대기다. 문의는 발송하지 않는다.
...
| G2.1 대표 업무 자료 검수 | 한 번에 한 업무의 근거를 확인하고 12개 후보의 검수 상태를 누적 | 가로등·도로·RD02·무단투기·기초연금·활동지원·기초생활보장·긴급복지 공개 대조 완료. 이용 범위·신고서·관할·정책 시점·하단 역할 확정은 추가 근거와 A·C 검토 대기 | A·C |
