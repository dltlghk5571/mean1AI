...
## 다음 한 가지 · G2.1 기초연금 안내·담당 근거 검수

- 상위 목표: G2 성남 업무에 맞는 근거 → G0 복지 문의에 근거·기준 시점과 신청 경로를 안내.
- 결과물: 기존 [공식 자료 작업표](docs/SEONGNAM_DATA_REVIEW.md)의 R02를 중심으로 기초연금
  한 건의 본문 문의처·하단 담당 표시·공식 업무표와 현재 후보를 대조한 기록.
- 완료 증거: 성남시 공식 안내의 조회 시각·정책 기준 연도·신청 경로·이용 표시를 확인하고,
  본문 문의처와 페이지 관리 부서가 실제 업무 담당을 입증하는지 구분. 대응 조직과 안내 질문의
  확인/미확인 범위, A·C의 적용 전 결정 사항을 남김.
- 제외: 개인별 수급 자격·금액 결정, 재산·소득 등 주민 정보 수집, 로그인·기관 문의 발송,
...
G2.1의 RD02와 무단투기 D01~05는 추가 공식 근거·A·C 검토 대기다. 문의는 발송하지 않는다.
...
| G2.1 대표 업무 자료 검수 | 한 번에 한 업무의 근거를 확인하고 12개 후보의 검수 상태를 누적 | 가로등·도로·RD02·무단투기 공개 대조 완료. 이용 범위·신고서·관할 확정은 추가 근거와 A·C 검토 대기 | A·C |
