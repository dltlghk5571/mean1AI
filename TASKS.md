...
## 다음 한 가지 · G2.1 장애인 활동지원 안내·담당 근거 검수

- 상위 목표: G2 성남 업무에 맞는 근거 → G0 활동지원 문의에 근거·기준 시점과 신청 경로를 안내.
- 결과물: 기존 [공식 자료 작업표](docs/SEONGNAM_DATA_REVIEW.md)의 R02를 중심으로 활동지원
  한 건의 본문 문의처·하단 담당 표시·공식 업무표와 현재 후보를 대조한 기록.
- 완료 증거: 공식 안내의 실제 조회 시각·정책 기준·신청 경로·이용 표시를 확인하고,
  신청·조사·결정 등 절차의 역할과 하단 표시를 구분. 후보 질문·조직 연결의 확인/미확인 범위와
  A·C의 적용 전 결정 사항을 남김.
- 제외: 개인별 지원 자격·시간·급여 결정, 장애·건강·소득 등 주민 정보 수집, 로그인·기관 문의 발송,
  다른 복지사업으로 확대, 후보 JSON·실자료 승인·모델·UI·새 플랫폼 구현.
- 의존성·종료: 공개 자료를 읽기 전용으로 대조. 시행 기준·조직 대응·이용 범위가 확인되지 않으면
  필요한 추가 근거와 담당을 남기고 한 업무에서 종료. 서버나 실제 참여자를 기다릴 필요는 없음.

G2.1의 RD02·무단투기 D01~05·기초연금 P01~05는 추가 근거·A·C 검토 대기다. 문의는 발송하지 않는다.
...
| G2.1 대표 업무 자료 검수 | 한 번에 한 업무의 근거를 확인하고 12개 후보의 검수 상태를 누적 | 가로등·도로·RD02·무단투기·기초연금 공개 대조 완료. 이용 범위·신고서·관할·하단 역할 확정은 추가 근거와 A·C 검토 대기 | A·C |
