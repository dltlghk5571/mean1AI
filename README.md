...
- 기본 비활성 모델 API 팩터리: 대화·분류·사건 비교 세 경로와 명시적 합성 응답, 실제 추론 주입 위치
...
자유 입력 의도 분류·공식 데이터 최종 검수·사진 AI 판독·기관 접수는 후속 범위입니다.
...
- [모델 API 서버 골격·세 경로·백엔드 주입·4명 전달물](docs/MODEL_GATEWAY.md)
