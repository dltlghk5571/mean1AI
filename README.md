...
3. 상세 화면에서 비식별 결과, 긴급도, 분류 근거, 담당 후보와 답변 초안을 확인합니다.
4. 담당 후보를 선택하고 `시민 화면 미리보기`를 확인한 뒤 `내부 검토 완료`로 로컬 감사 로그를 남깁니다.
5. 좌측 메뉴나 대기열 탭에서 검토 필요·긴급·배정 완료·검토 완료 상태를 필터링할 수 있습니다.
